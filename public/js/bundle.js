...
},{"core-js/shim":"../../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../../node_modules/core-js/fn/regexp/escape.js"}],"../../node_modules/moment/moment.js":[function(require,module,exports) {
var define;
var global = arguments[3];
//! moment.js
//! version : 2.29.0
...
var imageElement = document.getElementById('view-input-image');
var sendBtn = document.getElementById('analyze-button');
var barChart = document.getElementById('myChart');
var facialEl = document.getElementById('facepoints');
...
if (barChart) {
  _chart.default.defaults.global.defaultFontColor = 'white';
  var myChart = new _chart.default(barChart, {
    type: 'bar',
    data: {
      labels: _toConsumableArray(Object.keys(JSON.parse(barChart.dataset.emotions))),
      datasets: [{
        label: 'Emotions',
        data: _toConsumableArray(Object.values(JSON.parse(barChart.dataset.emotions))),
        backgroundColor: ['rgba(255, 99, 132, 0.5)', 'rgba(54, 162, 235, 0.5)', 'rgba(255, 206, 86, 0.5)', 'rgba(75, 192, 192, 0.5)', 'rgba(153, 102, 255, 0.5)', 'rgba(255, 159, 64, 0.5)', 'rgba(255, 99, 132, 0.5)', 'rgba(54, 162, 235, 0.5)'],
  ...
  if (facialEl) {
    var ctx = facialEl.getContext('2d');
    var box = JSON.parse(barChart.dataset.boundingBox);
    var organs = JSON.parse(barChart.dataset.organs);
    var WIDTH = 500;
    var HEIGHT = 400;

    var boundFace = function boundFace(boundBox) {
      ctx.strokeStyle = '#CCFF00';
      ctx.strokeRect(WIDTH * boundBox.Left, HEIGHT * boundBox.Top, WIDTH * boundBox.Width, HEIGHT * boundBox.Height);
    };

    boundFace(box);

    var mapPoints = function mapPoints(arr) {
      ctx.strokeStyle = '#FFFFFF';
      ctx.lineWidth = 2;
      ctx.beginPath();
      ctx.moveTo(WIDTH * arr[0].x, HEIGHT * arr[0].y);
      Object.values(arr).forEach(function (_ref) {
        var x = _ref.x,
            y = _ref.y;
    ...
    var getOrganPoints = function getOrganPoints(faceObj) {
      var resultObj = {
        leftBrowPoints: [faceObj.leftEyeBrowLeft, faceObj.leftEyeBrowRight, faceObj.leftEyeBrowUp],
        rightBrowPoints: [faceObj.rightEyeBrowLeft, faceObj.rightEyeBrowRight, faceObj.rightEyeBrowUp],
        rightEyePoints: [faceObj.rightEyeLeft, faceObj.rightEyeUp, faceObj.rightEyeRight, faceObj.rightEyeDown, faceObj.rightEyeLeft, faceObj.rightPupil, faceObj.eyeRight],
        leftEyePoints: [faceObj.leftEyeLeft, faceObj.leftEyeUp, faceObj.leftEyeRight, faceObj.leftEyeDown, faceObj.leftEyeLeft, faceObj.leftPupil, faceObj.eyeLeft],
        mouthPoints: [faceObj.mouthLeft, faceObj.mouthUp, faceObj.mouthRight, faceObj.mouthDown, faceObj.mouthLeft],
        nose: [faceObj.noseLeft, faceObj.nose, faceObj.noseRight],
        face: [faceObj.upperJawlineLeft, faceObj.midJawlineLeft, faceObj.chinBottom, faceObj.midJawlineRight, faceObj.upperJawlineRight]
      };
      return resultObj;
    };

    var organPoints = getOrganPoints(organs);
    Object.values(organPoints).forEach(function (arrPoints) {
      return mapPoints(arrPoints);
    });
    var onlyFaces = JSON.parse(barChart.dataset.raw).map(function (el) {
      return el.Landmarks;
    });
    var arrOrganPoints = onlyFaces.map(function (el) {
      var result = {};
      el.forEach(function (prop) {
        result[prop.Type] = {
          x: prop.X,
          y: prop.Y
        };
    ...
    arrOrganPoints.forEach(function (el) {
      var elPoints = getOrganPoints(el);
      Object.values(elPoints).forEach(function (arrPoints) {
        return mapPoints(arrPoints);
      });
    });
    var onlyBoundBoxes = JSON.parse(barChart.dataset.raw).map(function (el) {
      return el.BoundingBox;
    });
    onlyBoundBoxes.forEach(function (each) {
      boundFace(each);
    });
  }
}
},{"babel-polyfill":"../../node_modules/babel-polyfill/lib/index.js","chart.js":"../../node_modules/chart.js/dist/Chart.js"}],"../../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
