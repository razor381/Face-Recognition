...
if (barChart) {
  ...
  if (facialEl) {
    ...
    ctx.lineWidth = 3;
    ctx.strokeRect(WIDTH * box.Left, HEIGHT * box.Top, WIDTH * box.Width, HEIGHT * box.Height);
    ...
    var organPoints = {
      leftBrowPoints: [organs.leftEyeBrowLeft, organs.leftEyeBrowRight, organs.leftEyeBrowUp],
      rightBrowPoints: [organs.rightEyeBrowLeft, organs.rightEyeBrowRight, organs.rightEyeBrowUp],
      rightEyePoints: [organs.rightEyeLeft, organs.rightEyeUp, organs.rightEyeRight, organs.rightEyeDown, organs.rightEyeLeft, organs.rightPupil, organs.eyeRight],
      leftEyePoints: [organs.leftEyeLeft, organs.leftEyeUp, organs.leftEyeRight, organs.leftEyeDown, organs.leftEyeLeft, organs.leftPupil, organs.eyeLeft],
      mouthPoints: [organs.mouthLeft, organs.mouthUp, organs.mouthRight, organs.mouthDown, organs.mouthLeft],
      nose: [organs.noseLeft, organs.nose, organs.noseRight],
      face: [organs.upperJawlineLeft, organs.midJawlineLeft, organs.chinBottom, organs.midJawlineRight, organs.upperJawlineRight]
    };
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "34109" + '/');
